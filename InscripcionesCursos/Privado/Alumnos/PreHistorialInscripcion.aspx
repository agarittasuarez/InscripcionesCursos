...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="textoAngostoAlumnos">
        <p>
            <% 
                string styleOpen = "<b><i>";
                string styleClose = "</b></i>";
            %>      
            <%= String.Format(ConfigurationManager.AppSettings["ContentPreHistorialInscripcion"], styleOpen, styleClose, styleOpen, styleClose)%>
        </p>
    </div>
